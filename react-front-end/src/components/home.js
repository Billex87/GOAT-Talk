...
export default function Home(props) {
  ...
  '-1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000'}}>Player Stats</p>
                <img src={"/images/curry.png"} style={{height: '320px', width: '250px', position: 'relative', transition: '0.5s', zIndex: 11, transformStyle: 'preserve-3d', transform: 'translate3d(2%,-30%,0px)'}} alt="players" />
              </div>
          </Paper>
        </Tilt>
      </Link>
  ...
  '-1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000'}}>Standings</p>
                <img src={"/images/lebron.png"} style={{height: '290px', width: '140px', position: 'relative', transition: '0.5s', zIndex: 11, transformStyle: 'preserve-3d', transform: 'translate3d(20%,-30%,0px)'}} alt="standings" />
              </div>
          </Paper>
        </Tilt>
      </Link>
  ...
  '-1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000'}}>League Leaders</p>
                <img src={"/images/jimmy.png"} style={{height: '320px', width: '250px', position: 'relative', transition: '0.5s', zIndex: 11, transformStyle: 'preserve-3d', transform: 'translate3d(0%,-25%,0px)'}} alt="leaders" />
              </div>
          </Paper>
        </Tilt>
      </Link>
